...
test_that("data frame created", {
  ...
  expect_equal(df$Names$LVCovs$Numeric$Row, c("r.LV1", "r.LV2"))
  expect_equal(df$Names$LVCovs$Numeric$Col, c("c.LV1", "c.LV2"))
  expect_equal(df$Names$LVCovs$Factor$Row, character())
  expect_equal(df$Names$LVCovs$Factor$Col, c("c2.LV1", "c2.LV2"))
